...
set -euo pipefail
# ================================================================
# submit_eORCA025_ERA5v1_NOAC_pipeline.sh
#
# Description: Run NEMO Pipeline to extract the Overturning in
# the North Atlantic Changes (NOAC) hydrographic section
...
# Define filepaths:
config_file=eORCA025_ERA5v1_NOAC_config.toml
log_file=eORCA025_ERA5v1_NOAC_pipeline.log
