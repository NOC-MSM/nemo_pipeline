...
set -euo pipefail
# ================================================================
# submit_eORCA025_ERA5v1_MOVE_pipeline.sh
#
# Description: Run NEMO Pipeline to extract the Overturning in
# the Meridional Overturning Experiment (MOVE) hydrographic section
...
# Define filepaths:
config_file=eORCA025_ERA5v1_MOVE_config.toml
log_file=eORCA025_ERA5v1_MOVE_pipeline.log
