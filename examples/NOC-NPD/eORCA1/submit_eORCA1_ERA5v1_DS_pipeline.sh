...
set -euo pipefail
# ================================================================
# submit_eORCA1_ERA5v1_DS_pipeline.sh
#
# Description: Run NEMO Pipeline to extract the Davis Strait (DS)
# hydrographic section from the eORCA1-ERA5v1 simulation.
#
...
# Define filepaths:
config_file=eORCA1_ERA5v1_DS_config.toml
log_file=eORCA1_ERA5v1_DS_pipeline.log
